...
├── Python
│   ├── Clean Code in Python 2Nd Ed, Mariano Anaya
│   ├── CPython Internals, Anthony Shaw
│   ├── Cython: A Guide for Python Programmers, Kurt W. Smith
│   ├── Effective Python, Brett Slatkin
│   ├── Expert Python Programming 4th Ed, Michat Jaworski & Tarek Ziade
...
├── SQL
│   ├── Essential SQLAlchemy 2Nd Ed, Jason Myers & Rick Copeland
